...
<form action="insertdata.php" method = "post" class="was-validated"  enctype="multipart/form-data">
<div class="form-row">
...
<form class="form-inline">
    ...
    <div class="form-group">
    <label for file="file">Profile Pic: </label>
   <input type="file" name="file" class="form-control mx-sm-2" autocomplete= "off" required>
    <div class="invalid-feedback">Please fill out this field.</div>
 </div>
</div>
